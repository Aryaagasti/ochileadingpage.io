...
const Footer = () => {
  return (
    <>
      <footer className='w-full flex gap-5 h-screen bg-zinc-900 p-20 font-["Founders_Grotesk_X-Condensed"]'>
        <div className='w-1/2 h-full flex flex-col justify-between  '>
          <div className='heading'>
            <h1 className='text-[9vw] font-semibold uppercase leading-none tracking-tight -mb-7'>Eye-</h1>
            <h1 className='text-[9vw] font-semibold uppercase leading-none tracking-tight '>Opening</h1>
        ...
        <div className='w-1/2'>
          <h1 className='text-[6vw] font-semibold uppercase leading-none tracking-tight '>presentations</h1>
          <div className='dets font-["Neue_Montreal"]'>
            {["Facebook", "Instagram", "Tiwiter"].map((item, index) => <a className='block text-xl font-light  border-b-2' href='#'>{item}</a>)}
          </div>
          <br />
          <div className='dets1 font-["Neue_Montreal"]'>
            {["202-1965W4th Ave", "Vancover,Canada", "30 Chukariana ST ","Luviv,Ukraine"].map((item, index) => <a className='block text-xl font-light border-b-2' href='#'>{item}</a>)}
          </div>
        </div>
